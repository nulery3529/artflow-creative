  ...
  return (
    <div className="space-y-6 md:space-y-7">
      ...
      <div className="hidden md:flex items-start justify-between gap-6">
        <div>
          <h1 className="font-heading text-3xl lg:text-4xl tracking-tight">{greeting}, {firstName}!</h1>
          <p className="text-muted-foreground mt-2">Here’s what’s happening with your art business today.</p>
        </div>
      ...
      <section>
        <p className="text-xs text-muted-foreground mb-3 md:hidden">Live business overview</p>
        <div className="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-5 gap-3 md:gap-4">
          ...
          <MetricCard tone="blue" label="Orders" value={String(calc.orders)} loading={loading} />
          <MetricCard tone="mint" label="Items Sold" value={String(calc.itemsSold)} loading={loading} />
          <MetricCard tone="peach" label="Est. Net Profit" value={formatMoney(calc.estimatedNetProfit)} loading={loading} />
          <div className="col-span-2 md:col-span-1 md:[&>div]:h-full xl:col-span-1">
            <MetricCard tone="yellow" label="Avg Order Value" value={formatMoney(calc.avgOrderValue)} loading={loading} />
          </div>
        </div>
      </section>
